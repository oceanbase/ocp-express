...
@NoArgsConstructor
@Data
public class UnsupportedTypeOfBinaryOperationException extends ElException {
    ...
    @Override
    public void reThrow() {
        ExceptionUtils.throwException(ErrorCodes.EL_UNSUPPORTED_BINARY_OPERATOR, operation, left, right);
    }
}
