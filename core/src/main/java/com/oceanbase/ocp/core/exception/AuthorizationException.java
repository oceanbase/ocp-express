 ...
 */
public class AuthorizationException extends OcpException {

    public AuthorizationException(ErrorCode code) {
        super(HttpStatus.FORBIDDEN, code);
    }

    public AuthorizationException(ErrorCode code, Object... args) {
        super(HttpStatus.FORBIDDEN, code, args);
    }

    public AuthorizationException(Throwable cause, ErrorCode code, Object... args) {
        super(cause, HttpStatus.FORBIDDEN, code, args);
    }
}
