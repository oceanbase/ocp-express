 ...
 */
public class IllegalArgumentException extends OcpException {

    public IllegalArgumentException(ErrorCode code) {
        super(HttpStatus.BAD_REQUEST, code);
    }

    public IllegalArgumentException(ErrorCode code, Object... args) {
        super(HttpStatus.BAD_REQUEST, code, args);
    }

    public IllegalArgumentException(Throwable cause, ErrorCode code, Object... args) {
