...
sp_if
    : expr THEN sp_proc_stmts ((ELSE IF sp_if) | (ELSEIF sp_if) | (ELSE sp_proc_stmts))?
    ;

sp_proc_stmt_case
    : CASE expr sp_when_list ((ELSE IF sp_if) | (ELSEIF sp_if) | (ELSE sp_proc_stmts))? END_KEY CASE
    ;
