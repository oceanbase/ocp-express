...
@Converter
public class TaskContextConverter implements AttributeConverter<Context, String> {

    @Override
    public String convertToDatabaseColumn(Context attribute) {
    ...
    @Override
    public Context convertToEntityAttribute(String base64String) {
